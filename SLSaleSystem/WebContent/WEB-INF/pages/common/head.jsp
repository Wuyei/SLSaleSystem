			...
			<div class="well nav-collapse sidebar-nav">
				<ul class="nav nav-tabs nav-stacked main-menu" id="menus"></ul>
				    <c:forEach items="#{menuList}" var="menu">
				        <li class="nav nav-header hidden-tablet .list-unstyled">${menu.mainMenu.functionName}</li>
				        <c:forEach items="${menu.subMenu}" var="subMenu">
				        <li class=".list-unstyled"><a class="nav ajax-link" href="${subMenu.funcUrl}"><span class="hidden-tablet">${subMenu.functionName}</span></a></li>
				        </c:forEach>
				    </c:forEach>
			</div><!--/.well -->
		</div><!--/span-->
